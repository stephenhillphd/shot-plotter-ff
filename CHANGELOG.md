...
-   Fix overlapping ids between default details with special properties and custom details.
-   Fix special details existence checking to be based on type rather than id.
